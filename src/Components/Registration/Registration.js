...
import Terms from './Agreement/Enrollment Agreement.pdf'
            ...
            <div className='FormContainer'>
                ...
                <form className='FormHolder' onSubmit={Submit}>
                    ...
                    <div className='DownAgree'>
                        ...
                        I agree to The Curve <a href={Terms} target='blank'><span>Terms and conditions</span></a>
                    </div>
                    ...
                    <div className='DownSubmit'>
                        {
                         ! display ? (
                                ...
                                <>
                                    {!avatar ? (
                                                    <p style={{color:'red'}}>Please, select a photo to Register</p>
                                                ):( 
